...
def draw_labels_and_boxes(image, labels, boxes):
    ...
    image = cv2.rectangle(image, (x_min, y_min), (x_max, y_max), (0, 0, 255), thickness=2)
    image = cv2.putText(image, labels, (x_min, y_min), cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(255, 0, 0), thickness=2)
